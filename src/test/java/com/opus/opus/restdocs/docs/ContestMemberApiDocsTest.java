...
public class ContestMemberApiDocsTest extends RestDocsTest {
    ...
    void 멘토가_담당_대회_목록을_조회한다() throws Exception {
        ...
        when(contestMemberQueryService.getMentorContests(any())).thenReturn(response);
    ...
    void 멘토가_선택한_대회의_담당_팀_목록을_조회한다() throws Exception {
        ...
        when(contestMemberQueryService.getMentorContestTeams(any(), any())).thenReturn(response);
    ...
    void 멘토가_담당_팀의_제출물_및_피드백_상태를_조회한다() throws Exception {
        ...
        when(contestMemberQueryService.getTeamSubmissions(any(), any(), any())).thenReturn(response);
